function pctOverUnity = formattedScatter( tangle_1, tangle_2, labels, varargin )
% marker = 'o'; color = 'k';
% plotDataOnly = false;
...
Q90_1 = prctile(tangle_1,90); Q90_2 = prctile(tangle_2,90);
...
plot([Q90_2 Q90_2], [-.01*maxAxis .01*maxAxis],'Color',color,'LineWidth',3)
plot( [-.01*maxAxis .01*maxAxis], [Q90_1 Q90_1],'Color',[0 .5 1],'LineWidth',3)
